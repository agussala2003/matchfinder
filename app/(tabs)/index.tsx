      ...
      <ScrollView className="flex-1 px-4">
        ...
        <View className="flex-row justify-between items-center mt-4 mb-6">
          <View>
            ...
            <Text className="text-white font-title text-3xl uppercase tracking-wider">
              Agustín
            </Text>
          </View>
        ...
        <View className="bg-card rounded-2xl p-0 border border-gray-800 overflow-hidden mb-6">
          ...
          <View className="bg-green-900/20 p-3 flex-row justify-between items-center">
            <View className="flex-row items-center gap-1">
               ...
               <Text className="text-primary font-bodyBold text-xs uppercase">Sede: Fútbol 5 Palermo</Text>
            </View>
            <Text className="text-white font-title text-xs bg-red-600 px-2 py-0.5 rounded">HOY 20:00HS</Text>
          </View>
