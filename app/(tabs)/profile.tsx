  ...
  return (
    <ScreenLayout scrollable loading={loading} withPadding={false} className="bg-dark">
      ...
      <View className="bg-card rounded-b-[40px] border-b border-gray-800 mb-2">
         ...
         {uploading && <Text className="text-primary text-center text-xs pb-4">Actualizando foto...</Text>}
      </View>
...
const MenuOption = ({ icon, label, onPress, isLast }: { icon: any, label: string, onPress?: () => void, isLast: boolean }) => (
    <TouchableOpacity 
        onPress={onPress} 
