...
import { CATEGORIAS_EQUIPO, CATEGORIAS_LISTA, ZONAS_AMBA } from '@/lib/constants'; // <--- Imports nuevos
...
export default function CreateTeamScreen() {
  ...
  const [category, setCategory] = useState(''); // <--- Estado para categoría
      ...
      <View className="flex-1 py-8">
        ...
        <View className="gap-5">
          ...
          <View className="bg-blue-900/20 p-4 rounded-xl border border-blue-900/50 flex-row gap-3 mt-2">
            <View className="mt-1"><Shield size={16} color="#60A5FA" /></View>
            <Text className="text-blue-200 font-body text-xs flex-1 leading-5">
                Al crear el equipo, se generará un <Text className="font-bold">CÓDIGO ÚNICO</Text> para que puedas invitar a tus compañeros fácilmente.
            </Text>
          </View>
        </View>
