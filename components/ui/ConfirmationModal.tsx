      ...
      <TouchableWithoutFeedback onPress={onCancel}>
        <View className='flex-1 bg-black/80 justify-center items-center px-6'>
          ...
          <TouchableWithoutFeedback>
            <View className='bg-gray-900 border border-gray-800 w-full rounded-3xl p-6 shadow-2xl shadow-black'>
              {/* ICONO + TÍTULO */}
              <View className='items-center mb-5'>
                ...
                <Text className='text-white font-title text-xl text-center uppercase tracking-wide'>
                  {title}
                </Text>
              </View>

              {/* MENSAJE */}
              <Text className='text-gray-400 font-body text-center mb-8 leading-6 text-base px-2'>
                {message}
              </Text>
