...
export const Toast = ({ message, type, onHide }: ToastProps) => {
  ...
  useEffect(() => {
    ...
    // 2. Esperar 3 segundos y desaparecer
  ...
  return (
    <SafeAreaView 
      // FIX NATIVE:
      // 1. w-full: Ocupamos todo el ancho de la pantalla.
      // 2. items-center: Centramos el hijo (el toast) horizontalmente.
      // 3. pointerEvents="box-none": CLAVE en Native. Permite que los clicks pasen a través 
      //    de las áreas vacías del SafeAreaView, pero atrapa los clicks en el Toast.
        ...
        >
          ...
          >
            ...
            <View className="flex-1">
              ...
              <Text className="text-white font-body text-sm leading-5">
                {message}
              </Text>
            </View>
          </TouchableOpacity>
